...
#define __SSD1331_RES_SET()     HAL_GPIO_WritePin(OLED_RES_GPIO_Port, OLED_RES_Pin, 1)
#define __SSD1331_RES_CLR()     HAL_GPIO_WritePin(OLED_RES_GPIO_Port, OLED_RES_Pin, 0)

#define __SSD1331_DC_SET()      HAL_GPIO_WritePin(OLED_DC_GPIO_Port, OLED_DC_Pin, 1)
#define __SSD1331_DC_CLR()      HAL_GPIO_WritePin(OLED_DC_GPIO_Port, OLED_DC_Pin, 0)

#define __SSD1331_CS_SET()      HAL_GPIO_WritePin(OLED_CS_GPIO_Port, OLED_CS_Pin, 1)
#define __SSD1331_CS_CLR()      HAL_GPIO_WritePin(OLED_CS_GPIO_Port, OLED_CS_Pin, 0)
